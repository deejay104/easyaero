<?php
	...
	$tabLang["lang_nocheck"]="Le pilote sélectionné n'est pas laché sur cet avion.";
    ...
    $tabLang["lang_horasaved"]="Les informations d'horamètre ont été sauvegardées";

    $tabLang["lang_horastart"]="Horamètre début";
    $tabLang["lang_horastartend"]="Horamètre fin";
    $tabLang["lang_realtime"]="Temps de vol réel";

    $tabLang["lang_lastupdate"]="Dernière mise à jour";
    $tabLang["lang_potentiel"]="Potentiel restant à la prise en charge";

    $tabLang["lang_explainaccount"]="Choisissez un autre compte à débiter. Par exemple dans le cas d'un baptème, c'est le compte du club qui est débité";
