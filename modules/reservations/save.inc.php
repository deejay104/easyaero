...
// ---- Enregistre
	...
	if ($fonc=="annuler")  	
	{
		$dte=($resa["resa"]->dte_deb!="0000-00-00") ? $resa["resa"]->dte_deb : $form_dte_deb;
echo $dte."**".extractDate($dte);
				header('Location: /reservations/'.(($prev=="scheduler") ? "scheduler" : "").'?start='.extractDate($dte), true, 303);
    	exit;
	}
