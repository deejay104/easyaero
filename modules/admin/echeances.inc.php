...
// ---- Supprime une échéance
	...
	foreach($lstEcheance as $i=>$d)
	{
		...
		$tabValeur[$i]["action"]["aff"]="<div  style='width: 32px;'><span class='feed-actions'><a id='edit_".$id."' href='".geturl("admin","echeances","fonc=delete&id=".$id)."'><i class='mdi mdi-close'></i></a></span></div>";
