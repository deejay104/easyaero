...
// ---- Affiche la liste
	...
	foreach($lst as $i=>$d)
	{
		...
		$tabValeur[$i]["action"]["aff"]="<span class='feed-actions'><a id='del_".$d["id"]."' href='".geturl("admin","formations","page=references&fonc=delete&fid=".$fid."&id=".$d["id"])."'><i class='mdi mdi-close mdi-18px'></i></a></span>";
	}
