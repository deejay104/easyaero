<?php
	...
	$tabLang["lang_showsign"]="Afficher les signatures";


	$tabLang["lang_movement"]="Mouvement";
	$tabLang["lang_comment"]="Commentaire";
	$tabLang["lang_amount"]="Montant";
	$tabLang["lang_balance"]="Solde";

	$tabLang["lang_tranfert"]="Transfère de votre compte vers celui d'un autre membre";

	$tabLang["lang_tranfertexplain"]="Vous pouvez effectuer un transfert de votre compte vers celui d'un autre membre. Attention, votre transfert ne peut excéder le solde de votre compte. Laisser un commentaire afin que qu'il soit plus facilement identifiable par le membre destinataire.";
